...
- edit the `config.toml` file in `exampleSite/` to reflect the `plateaux-numeriques-theme`
...
- edit the `config.toml` file in `new-site/` to reflect the plateaux-numeriques-theme
...
Your content should go into `new-site/content`, the development of the site layout is done within `new-site/themes/plateaux-numeriques-theme/layout`.
